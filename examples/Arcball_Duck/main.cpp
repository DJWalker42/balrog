...
int main(){	 
	...
	//initialise the viewport with the window, camera, and camera control method choice (arcball in this example).
	app::initViewPort(window, &camera, app::ARC, translateSpeed, rotateSpeed);
