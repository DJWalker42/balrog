#ifndef DJW_TEAPOTDATA_H
#define DJW_TEAPOTDATA_H

/*	I obtained this data by googling opengl teapot however I failed to
	note the specific website I got it from - there are plenty of sources*/
