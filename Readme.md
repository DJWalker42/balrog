...
Disclaimer: The files contained in the resources directory are not of my creation. I obtained them from the samples directory of MeshLab (http://meshlab.sourceforge.net/).
